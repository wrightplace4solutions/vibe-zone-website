    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="py-12 sm:py-20 px-3 sm:px-4 relative overflow-hidden">
        ...
        <div className="container mx-auto relative z-10 max-w-4xl text-center">
          ...
          <p className="text-base sm:text-xl md:text-2xl text-muted-foreground mb-6 sm:mb-8 animate-fade-in">
            The interactive DJ app that turns passive listeners into active participants
          </p>
          
          <div className="flex flex-wrap gap-3 sm:gap-4 justify-center animate-fade-in">
            <Button 
              size="default"
              className="bg-primary hover:bg-primary/90 text-primary-foreground font-bold text-sm sm:text-base px-4 sm:px-6 py-4 sm:py-5"
              asChild
            >
              <a href="#demo-video">
                Watch VibeQue Demo
            ...
            <Button 
              size="default"
              variant="outline"
              className="font-bold text-sm sm:text-base px-4 sm:px-6 py-4 sm:py-5"
              asChild
            >
      ...
      {/* Demo Video Section */}
      <section id="demo-video" className="py-12 sm:py-20 px-3 sm:px-4 bg-card/30">
        <div className="container mx-auto max-w-4xl text-center">
          <div className="mb-4 sm:mb-6">
            <Video className="w-10 h-10 sm:w-14 sm:h-14 md:w-16 md:h-16 mx-auto mb-3 sm:mb-4 text-primary animate-pulse" />
          ...
          <div className="relative aspect-video bg-muted rounded-lg overflow-hidden border-2 border-border">
            <div className="absolute inset-0 flex flex-col items-center justify-center p-4">
              <Play className="w-12 h-12 sm:w-16 sm:h-16 md:w-20 md:h-20 text-primary mb-3 sm:mb-4 animate-pulse" />
              <p className="text-base sm:text-lg md:text-xl font-semibold text-foreground">Demo Video Coming Soon!</p>
      ...
      <section className="py-12 sm:py-20 px-3 sm:px-4 bg-card/50">
        <div className="container mx-auto max-w-6xl">
          ...
          <p className="text-sm sm:text-base md:text-xl text-muted-foreground text-center mb-8 sm:mb-12">
              ...
              return (
                ...
                >
                  <CardContent className="p-4 sm:p-6">
                    <div className="w-10 h-10 sm:w-12 sm:h-12 md:w-14 md:h-14 rounded-full bg-primary/20 flex items-center justify-center mb-3 sm:mb-4">
                      <Icon className="w-5 h-5 sm:w-6 sm:h-6 md:w-7 md:h-7 text-primary" />
                    </div>
                    <h3 className="font-bold text-base sm:text-lg md:text-xl mb-1.5 sm:mb-2 text-foreground">
                      {feature.title}
                    </h3>
          ...
          <div className="grid md:grid-cols-2 gap-4 sm:gap-6 md:gap-8">
            {benefits.map((benefit, index) => {
              ...
              return (
                <div 
                  key={index}
                  className="flex gap-4 sm:gap-6 p-4 sm:p-6 rounded-lg bg-card/50 border border-border hover:border-primary/50 transition-all animate-fade-in"
                  style={{ animationDelay: `${index * 0.1}s` }}
                >
                  <div className="flex-shrink-0">
                    <div className="w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 rounded-full bg-accent/20 flex items-center justify-center">
                      <Icon className="w-6 h-6 sm:w-7 sm:h-7 md:w-8 md:h-8 text-accent" />
                    </div>
                  </div>
                  <div>
                    <h3 className="font-bold text-lg sm:text-xl md:text-2xl mb-1.5 sm:mb-2 text-foreground">
                      {benefit.title}
                    </h3>
                    <p className="text-sm sm:text-base md:text-lg text-muted-foreground">
                      {benefit.description}
      ...
      <section className="py-12 sm:py-20 px-3 sm:px-4 bg-card/30">
        <div className="container mx-auto max-w-6xl">
          <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-center mb-2 sm:mb-4">
          ...
          <div className="grid md:grid-cols-2 gap-8 sm:gap-10 md:gap-12">
            ...
            <div className="space-y-4 sm:space-y-6">
              <h3 className="text-xl sm:text-2xl md:text-3xl font-bold text-center mb-4 sm:mb-6 md:mb-8 text-primary">For DJs</h3>
              
              <div className="flex gap-3 sm:gap-4 p-4 sm:p-6 rounded-lg bg-card border border-border hover:border-primary/50 transition-all">
                <div className="flex-shrink-0">
                  <div className="w-10 h-10 sm:w-12 sm:h-12 md:w-14 md:h-14 rounded-full bg-primary/20 flex items-center justify-center">
                    <Headphones className="w-5 h-5 sm:w-6 sm:h-6 md:w-7 md:h-7 text-primary" />
                  </div>
                </div>
                <div>
                  <h4 className="font-bold text-base sm:text-lg md:text-xl mb-1.5 sm:mb-2 text-foreground">Stay in Control</h4>
                  <p className="text-xs sm:text-sm text-muted-foreground">
              ...
              <div className="flex gap-3 sm:gap-4 p-4 sm:p-6 rounded-lg bg-card border border-border hover:border-primary/50 transition-all">
                ...
                <div>
                  <h4 className="font-bold text-base sm:text-lg md:text-xl mb-1.5 sm:mb-2 text-foreground">Stand Out from Competition</h4>
                  <p className="text-xs sm:text-sm text-muted-foreground">
              ...
              <div className="flex gap-3 sm:gap-4 p-4 sm:p-6 rounded-lg bg-card border border-border hover:border-primary/50 transition-all">
                <div className="flex-shrink-0">
                  <div className="w-10 h-10 sm:w-12 sm:h-12 md:w-14 md:h-14 rounded-full bg-primary/20 flex items-center justify-center">
                    <BarChart className="w-5 h-5 sm:w-6 sm:h-6 md:w-7 md:h-7 text-primary" />
                  </div>
                </div>
                <div>
                  <h4 className="font-bold text-base sm:text-lg md:text-xl mb-1.5 sm:mb-2 text-foreground">Event Insights</h4>
                  <p className="text-xs sm:text-sm text-muted-foreground">
            ...
            <div className="space-y-4 sm:space-y-6">
              <h3 className="text-xl sm:text-2xl md:text-3xl font-bold text-center mb-4 sm:mb-6 md:mb-8 text-primary">For Line Dance Instructors</h3>
              
              <div className="flex gap-3 sm:gap-4 p-4 sm:p-6 rounded-lg bg-card border border-border hover:border-primary/50 transition-all">
                <div className="flex-shrink-0">
                  <div className="w-10 h-10 sm:w-12 sm:h-12 md:w-14 md:h-14 rounded-full bg-primary/20 flex items-center justify-center">
                    <Music2 className="w-5 h-5 sm:w-6 sm:h-6 md:w-7 md:h-7 text-primary" />
                  </div>
                </div>
                <div>
                  <h4 className="font-bold text-base sm:text-lg md:text-xl mb-1.5 sm:mb-2 text-foreground">Keep Your Flow</h4>
                  <p className="text-xs sm:text-sm text-muted-foreground">
              ...
              <div className="flex gap-3 sm:gap-4 p-4 sm:p-6 rounded-lg bg-card border border-border hover:border-primary/50 transition-all">
                ...
                <div>
                  <h4 className="font-bold text-base sm:text-lg md:text-xl mb-1.5 sm:mb-2 text-foreground">Perfect for Classes</h4>
                  <p className="text-xs sm:text-sm text-muted-foreground">
              ...
              <div className="flex gap-3 sm:gap-4 p-4 sm:p-6 rounded-lg bg-card border border-border hover:border-primary/50 transition-all">
                ...
                <div>
                  <h4 className="font-bold text-base sm:text-lg md:text-xl mb-1.5 sm:mb-2 text-foreground">No Extra Equipment</h4>
                  <p className="text-xs sm:text-sm text-muted-foreground">
      ...
      <section className="py-12 sm:py-20 px-3 sm:px-4 bg-card/50">
        <div className="container mx-auto max-w-2xl">
          ...
          <form onSubmit={handleDemoRequest} className="space-y-4 sm:space-y-6 bg-card p-4 sm:p-6 md:p-8 rounded-lg border border-border">
            ...
            <div className="space-y-2 sm:space-y-3">
              <Label className="text-foreground text-sm">I am a...</Label>
              <RadioGroup value={userType} onValueChange={setUserType}>
                <div className="flex items-center space-x-2">
                  <RadioGroupItem value="dj" id="dj" />
                  <Label htmlFor="dj" className="font-normal cursor-pointer text-sm">DJ</Label>
                </div>
                <div className="flex items-center space-x-2">
                  <RadioGroupItem value="instructor" id="instructor" />
                  <Label htmlFor="instructor" className="font-normal cursor-pointer text-sm">Line Dance Instructor</Label>
                </div>
                <div className="flex items-center space-x-2">
                  <RadioGroupItem value="event_planner" id="event_planner" />
                  <Label htmlFor="event_planner" className="font-normal cursor-pointer text-sm">Event Planner</Label>
                </div>
              </RadioGroup>
            </div>
            ...
            <Button 
              type="submit" 
              className="w-full bg-primary hover:bg-primary/90 text-primary-foreground font-bold text-sm sm:text-base"
      ...
      <section className="py-12 sm:py-20 px-3 sm:px-4 relative overflow-hidden">
        ...
        <div className="container mx-auto max-w-4xl text-center relative z-10">
          ...
          <Button 
            size="default"
            className="bg-accent hover:bg-accent/90 text-accent-foreground font-bold text-sm sm:text-base md:text-lg px-4 sm:px-6 md:px-8 py-4 sm:py-5 md:py-6"
            asChild
          >
