  ...
  return <section className="relative min-h-[80vh] flex items-center justify-center overflow-hidden bg-gradient-hero pt-20">
      ...
      <div className="relative z-10 container mx-auto px-4 text-center animate-fade-in">
        <div className="max-w-4xl mx-auto">
          <img src={vibeZoneLogo} alt="Vibe Zone Entertainment - DJ Def Stef specializing in Line Dance and Trail Ride music" className="w-full max-w-md mx-auto mb-8 animate-glow-pulse" loading="eager" />
